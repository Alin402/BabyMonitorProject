...
namespace BabyMonitorApiDataAccess.Migrations
{
    ...
    [Migration("20240517102142_AddedNewFieldToLivestreamEntity")]
    partial class AddedNewFieldToLivestreamEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BabyMonitorApiDataAccess.Entities.MonitoringDevice", b =>
                {
                    b.HasOne("BabyMonitorApiDataAccess.Entities.Baby", "_Baby")
                        .WithOne()
                        .HasForeignKey("BabyMonitorApiDataAccess.Entities.MonitoringDevice", "BabyId");
