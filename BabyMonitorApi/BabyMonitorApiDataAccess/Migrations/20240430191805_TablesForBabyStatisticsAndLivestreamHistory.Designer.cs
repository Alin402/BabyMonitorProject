...
namespace BabyMonitorApiDataAccess.Migrations
{
    ...
    [Migration("20240430191805_TablesForBabyStatisticsAndLivestreamHistory")]
    partial class TablesForBabyStatisticsAndLivestreamHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BabyMonitorApiDataAccess.Entities.Livestream", b =>
                {
                    ...
                    b.Property<Guid?>("MonitoringDeviceId")
                        .IsRequired()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BabyMonitorApiDataAccess.Entities.Livestream", b =>
                {
                    ...
                    b.HasOne("BabyMonitorApiDataAccess.Entities.MonitoringDevice", "_MonitoringDevice")
                        .WithMany("Livestreams")
