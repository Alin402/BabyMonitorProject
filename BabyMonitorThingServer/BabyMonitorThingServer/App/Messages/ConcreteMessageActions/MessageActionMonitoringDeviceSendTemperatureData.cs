...
{
    internal class MessageActionMonitoringDeviceSendTemperatureData : IMessageAction
    {
        public IMessageValidator Validator { get; set; }

        public MessageActionMonitoringDeviceSendTemperatureData(IMessageValidator validator)
        {
            Validator = validator;
        }
